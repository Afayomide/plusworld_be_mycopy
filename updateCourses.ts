...
connectToMongo(dburl)
  .then(async () => {
    ...
    const courses = [
      {
        ...
        courseImage:
          "https://plusworld.s3.amazonaws.com/course-images/plusworld+mockup4.png",
        tutors: [
          {
            name: "Ajenifuja Folorunso",
            about:
              "Expert in Roofing Systems with over 15 years of experience.",
        ...
        courseMedia:
          "https://plusworld.s3.amazonaws.com/coursefiles/1.+INTRODUCTION+TO+ROOFS+AND+ROOFING+SYSTEMS.+Ebizi1.pptx",
        courseModules: [
          {
            ...
            lessons: [
              {
                ...
                lessonIndex: 1,
                mediaUrl:
                  "https://plusworld.s3.amazonaws.com/coursefiles/introduction-to-roof-maintenance-and-repairs/Lesson+1.pptx",
              },
              {
                lessonNo: "Lesson2",
                lessonIndex: 2,
                mediaUrl:
                  "https://plusworld.s3.amazonaws.com/coursefiles/introduction-to-roof-maintenance-and-repairs/Lesson+2.pptx",
              },
            ],
          },
          {
            ...
            lessons: [
              {
                ...
                lessonIndex: 1,
                mediaUrl:
                  "https://plusworld.s3.amazonaws.com/coursefiles/introduction-to-roof-maintenance-and-repairs/Lesson+3.pptx",
              },
              {
                lessonNo: "Lesson2",
                lessonIndex: 2,
...

      {
        ...
        courseImage:
          "https://plusworld.s3.amazonaws.com/course-images/plusworld+mockup2.png",
        tutors: [
          {
            name: "Tunde Adebayo",
            about:
              "Specialist in Structural Waterproofing with extensive industry experience.",
        ...
        courseCategory: "Construction",
        courseMedia:
          "https://plusworld.s3.amazonaws.com/coursefiles/3.+ROOF+AND+STRUCTURAL+WATERPROOFING.pptx",
        courseModules: [
          {
            moduleName: "Module 1: Roof Basics",
            moduleIndex: 1,
...

      {
        ...
        courseImage:
          "https://plusworld.s3.amazonaws.com/course-images/plusworld+mockup5.png",
        tutors: [
          {
            name: "Ifeoma Obi",
            about:
              "Business Management expert with a focus on the Roofing industry.",
        ...
        courseMedia:
          "https://plusworld.s3.amazonaws.com/coursefiles/5.+ROOFING+BUSINESS+MGT.pptx",
        courseModules: [
          {
            moduleName: "Module 1: Roof Basics",
            moduleIndex: 1,
        ...
        graduation: "Professional Certificate",
        description:
          "This course would teach you everything you need to know about the roofing business and how to create a sturdy company. It will address the major issues and problems that contractors face in operating a roofing business.",
        modules: [
...

      {
        ...
        courseImage:
          "https://plusworld.s3.amazonaws.com/course-images/plusworld+mockup6.png",
        tutors: [
          {
            name: "Ngozi Okeke",
        ...
        courseMedia:
          "https://plusworld.s3.amazonaws.com/coursefiles/2.+INTRODUCTION+TO+ROOF+MAINTENANCE+AND+REPAIRS.pptx",
        courseModules: [
          {
            moduleName: "Module 1: Roof Basics",
            moduleIndex: 1,
        ...
        graduation: "Professional Certificate",
        description:
          "This course will discuss the causes and effects of roof damage and the practical skills required to make proper roof inspections and identify solutions. It will also explain types of maintenance, how to plan maintenance and how to select the proper materials to use.",
        modules: [
...

      {
        ...
        courseImage:
          "https://plusworld.s3.amazonaws.com/course-images/plusworld+mockup.png",
        tutors: [
          {
            name: "Aisha Bello",
            about:
              "Roof Restoration specialist with hands-on experience in various roof substrates.",
        ...
        courseMedia:
          "https://plusworld.s3.amazonaws.com/coursefiles/4.+ROOF+RESTORATIONEbizi.pptx",
        courseModules: [
          {
            moduleName: "Module 1: Roof Basics",
            moduleIndex: 1,
...

      {
        ...
        courseImage:
          "https://plusworld.s3.amazonaws.com/course-images/plusworld+mockup3.png",
        tutors: [
          {
            name: "Femi Ogunleye",
            about:
              "HSE expert with a focus on safety protocols for working at heights.",
        ...
        courseMedia:
          "https://plusworld.s3.amazonaws.com/coursefiles/6.+HSE-+SAFETY+AT+HEIGHT+%26+WORKPLACE+(1).pptx",
        courseModules: [
          {
            moduleName: "Module 1: Roof Basics",
            moduleIndex: 1,
        ...
        graduation: "Certificate of Completion",
        description:
          "This course will expose the trainees to areas of present and potential hazards when working at height and workplace with emphasis on the roofs and roofing systems. Learners would be well equipped with safety rules, procedures and safety signs for work at heights and general work environment.",
        module: [
    ...
    const updates = [
      { topic: "Roof Restoration", tutors: [{ name: "Abiye Sekibo Tom" }] },
      {
        topic: "HSE - Safety At Height & Workplace",
        tutors: [
          {
            name: "Lawrence Ojurongbe",
          },
        ],
      },
      {
        topic: "Roof And Structural Waterproofing",
        tutors: [
          {
            name: "Kingsley",
          },
      ...
      {
        topic: "Introduction To Roofs And Roofing Systems",
        tutors: [
          {
            name: "Ajenifuja Folorunso",
          },
      ...
      {
        topic: "Introduction To Roof Maintenance And Repairs",
        tutors: [
          {
            name: "Abiola Oladipo",
          },
    ...
    async function updateNamesInBulk() {
      const bulkOps = updates.map((update) => ({
        updateOne: {
          filter: { courseName: update.topic },
          update: { $push: { tutors: { $each: update.tutors } } },
        },
      }));
